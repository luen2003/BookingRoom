...
class RoomController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('room.index'))->with('success', 'Berhasil Menyimpan Data Room');
    }
    ...
    public function update(Request $request, Room $room)
    {
        ...
        return redirect(route('room.index'))->with('success', 'Berhasil Memperbarui Data Room');
    }
    ...
    public function destroy(Room $room)
    {
        try {
            ...
            $msg = 'Berhasil Menghapus Data Room';
