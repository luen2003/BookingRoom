@extends('layouts.app', ['title' => 'List Room', 'page' => 'room'])
...
@section('content')
  <div class="card">
    <h5 class="card-header">List Room 
    @admin
      <a href="{{ route('room.create') }}"><button class="btn rounded-pill btn-primary float-end mx-2"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 26 26" style="fill: rgba(255, 255, 255, 1);transform: ;msFilter:;"><path d="M19 11h-6V5h-2v6H5v2h6v6h2v-6h6z"></path></svg> Room</button></a> 
    @endadmin
    </h5>
  ...
  <script>
    ...
    function openModal(room_id, room_name) {
      ...
      $('#text-modal').html(`<div class="text-capitalize">
                              <br>
                              <div class="mt-2">
                                <p>Data room <em>tidak bisa</em> dihapus. Edit room dan pilih Status 'tidak bisa dipakai' agar room tidak dipesan.</p>
                              </div>
                              </div>`)
      $('#btn-modal').remove()
