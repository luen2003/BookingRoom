...
@section('content')
  ...
  <div class="row">
    <div class="col-md-8">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title text-primary mb-4">Booking Statistics</h4>
          <div class="row">
            ...
            <div class="col-4 text-center">
              <span class="fw-semibold d-block mb-1 text-capitalize">Approved</span>
              <h3 class="card-title mb-3">{{ $approved }}</h3>
            </div>
            <div class="col-4 text-center">
              <span class="fw-semibold d-block mb-1 text-capitalize">Denied</span>
              <h3 class="card-title mb-3">{{ $rejected }}</h3>
            </div>
            <div class="col-4 text-center">
              <span class="fw-semibold d-block mb-1 text-capitalize">Used</span>
              <h3 class="card-title mb-3">{{ $used }}</h3>
            </div>
            <div class="col-4 text-center">
              <span class="fw-semibold d-block mb-1 text-capitalize">Cancelled</span>
              <h3 class="card-title mb-3">{{ $canceled }}</h3>
            </div>
            <div class="col-4 text-center">
              <span class="fw-semibold d-block mb-1 text-capitalize">Completed</span>
            ...
            <div class="col-4 text-center">
              <span class="fw-semibold d-block mb-1 text-capitalize">Reschedule</span>
          ...
          <div class="card-title d-flex align-items-start">
            ...
            <div class="mx-4">
              <a href="{{ route('admin-booking-list') }}">
                <span class="fw-semibold d-block mb-1">Total Request Booking</span>
      ...
      <a href="{{ route('room.index') }}">
        <div class="card">
          <div class="card-body">
            ...
            <span class="fw-semibold d-block mb-1">Total Room</span>
  ...
  <div class="card">
    <h5 class="card-header">Booking Data For Today</h5>
        ...
        <tbody>
          ...
          <tr>
            <td class="text-center">
              @if(isset($list->room->photo)) <img src="{{ asset($list->room->photo) }}" style="object-fit: cover;" height="125" alt="Photo Room {{ $list->room->name }}"> @else - @endif
