<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-header small text-uppercase">
      <span class="menu-header-text">Pemesanan Room</span>
    </li>
    <li class="menu-item">
    ...
    @else
    <li class="menu-header small text-uppercase">
      <span class="menu-header-text">Room</span>
    </li>
    <li class="menu-item">
        <li class="menu-item {{ ($page == 'room') ? 'active' : '' }}">
          <a href="{{ route('view-room') }}" class="menu-link">
            <i class="menu-icon tf-icons bx bx-building"></i>
            <div data-i18n="Account">List Room</div>
          </a>
        </li>
    </li>

    <li class="menu-header small text-uppercase">
      <span class="menu-header-text">Reservation Room</span>
    </li>
    <li class="menu-item">
      <li class="menu-item {{ ($page == 'book') ? 'active' : '' }}">
