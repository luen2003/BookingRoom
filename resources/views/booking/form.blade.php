  ...
  <div class="card">
    ...
    <div class="card-body">
      <form action="{{ $url }}" method="POST">
        ...
        @method($method)
        <div class="mb-3">
          <label class="form-label" for="basic-icon-default-room">Room</label>
          <div class="input-group input-group-merge">
            <span id="basic-icon-default-room2" class="input-group-text">Select Room</span>
        ...
        <div class="mb-3">
          <label class="form-label" for="basic-icon-default-start">Time Start</label>
          <div class="input-group input-group-merge">
            <input class="form-control" type="time" name="start" value="{{ $start }}" id="basic-icon-default-start" required />
          </div>
        </div>
        <div class="mb-3">
          <label class="form-label" for="basic-icon-default-end">Time End</label>
          <div class="input-group input-group-merge">
            <input class="form-control" type="time" name="end" value="{{ $end }}" id="basic-icon-default-end" required />
          </div>
        </div>
        <div class="mb-3">
          <label class="form-label" for="basic-icon-default-need">Requirement</label>
          <div class="input-group input-group-merge">
